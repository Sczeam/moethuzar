  ...
  return (
    <section aria-label="Daily summary metrics">
      ...
      <dl className="mt-5 grid gap-3 sm:grid-cols-3">
        <div className="rounded-xl border border-sepia-border/60 bg-parchment p-3">
          <dt className="text-xs uppercase tracking-[0.08em] text-charcoal">Orders Today</dt>
          <dd className="mt-1 text-3xl font-semibold text-ink">{metrics.ordersToday}</dd>
        </div>
        <div className="rounded-xl border border-sepia-border/60 bg-parchment p-3">
        ...
        <div className="rounded-xl border border-sepia-border/60 bg-parchment p-3">
          ...
          <dd className="mt-1 text-3xl font-semibold text-ink">{metrics.pendingPaymentReviews}</dd>
        </div>
      </dl>
    </section>
  );
